...
int pauseGamePressed=0, pauseResumePressed=0, pauseSavePressed=0, pauseMenuPressed=0, saveGame=0, slotSelect=0, 
	...
	gameOver=0, congratsShow=0, nameInput=0, flag=0, hofShow=0, thanksShow=0, creditShow=0, instructionShow=0;

int textbox=0,len=0,warning=0,clicked=0,flagEgg=0;
